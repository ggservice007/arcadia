...
def text_manipulate(req_json, opt={}):
    ...
    for file_name in file_names:
        minio_store_client.download(minio_client, {
    ...
    minio_store_client.upload_files_to_minio_with_tags(minio_client, {
    ...
    data_process_db_operate.update_status_by_id(update_params, {
        'pool': opt['pool']
    })
